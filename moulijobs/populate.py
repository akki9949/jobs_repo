import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE','moulijobs.settings')
import django
django.setup()
...
def populate(n):
    for i in range(n):
        ...
        ftitle=fake.random_element(elements=('Project Manager','TeamLead','Software Engineer','Associate Engineer'))
        feligibility=fake.random_element(elements=('B.Tech','M.Tech','MCA','MBA','PHD'))
